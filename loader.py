...
class WSDInstance:
    def __init__(self, my_id, lemma, context, index, pos):
        ...
        # ADDED : 
        self.pos = pos          # added this for the GloVe method
    def __str__(self):
        '''
        ...
        for sentence in text:
            ...
            for i, el in enumerate(sentence):
                if el.tag == 'instance':
                    ...
                    # added this line for the pos
                    pos = el.attrib['pos']
                    instances[my_id] = WSDInstance(my_id, lemma, context, i, pos) # added pos here too
...
def to_ascii(s):
    ...
    return codecs.encode(s, 'ascii', 'ignore').decode('ascii')  # fixed this for python3
